...
import { BrandSymbol } from '../../src/components/common/BrandLogo'
        ...
        <div className="flex w-full max-w-[18rem] flex-col bg-slate-950 p-4 lg:max-w-none lg:p-5">
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              <BrandSymbol tone="white" className="size-10 shrink-0" />
              <p className="text-xs font-extrabold uppercase tracking-[0.14em] text-brand-200">Centro de control</p>
            </div>
