...
export function normalizeBusinessSettings(settings = {}) {
  ...
  return {
    ...
    defaultTargetMargin: numberInRange(settings.defaultTargetMargin, defaultBusinessSettings.defaultTargetMargin, 1, 90),
...
export function mapBusinessSettings(row) {
  ...
  return normalizeBusinessSettings({
    ...
    defaultTargetMargin: row.default_target_margin,
...
export function businessSettingsToRow(settings) {
  ...
  return {
    ...
    default_target_margin: normalized.defaultTargetMargin,
